 ...
 * <!-- end-user-doc -->
 * @see sensingflow.model.SensingflowPackage#getSensingflowProceduralLinkKind()
 * @model
 * @generated
 */
public enum SensingflowProceduralLinkKind implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final SensingflowProceduralLinkKind[] VALUES_ARRAY =
		new SensingflowProceduralLinkKind[] {
			AGENT,
			INSTRUMENT,
			CONSUMPTION,
			EFFECT,
	 ...
	 * @generated
	 */
	public static final List<SensingflowProceduralLinkKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static SensingflowProceduralLinkKind get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SensingflowProceduralLinkKind result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static SensingflowProceduralLinkKind getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SensingflowProceduralLinkKind result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static SensingflowProceduralLinkKind get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private SensingflowProceduralLinkKind(int value, String name, String literal) {
		this.value = value;
		this.name = name;
