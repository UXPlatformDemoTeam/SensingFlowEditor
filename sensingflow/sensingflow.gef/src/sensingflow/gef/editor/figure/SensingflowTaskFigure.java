...
public class SensingflowTaskFigure extends RoundedRectangle implements SensingflowThingFigure {
	public static Color colorFg = new Color(null, 255, 192, 0 );
	public static Color colorBg = new Color(null, 255, 214, 134 );
